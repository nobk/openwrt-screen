...
PKG_NAME:=screen-git
PKG_SOURCE_DATE:=2023-12-30
PKG_RELEASE:=1

PKG_SOURCE_PROTO:=git
PKG_SOURCE_URL:=https://git.savannah.gnu.org/git/screen.git
PKG_SOURCE_VERSION:=6df4a48ff6b31bedc2d0216b84dbe66cf9ca5e23
PKG_MIRROR_HASH:=fd246a2f3be00fde671917ba225b4c7c2d78fbf8d5c8439720dcf3962cc91d52
